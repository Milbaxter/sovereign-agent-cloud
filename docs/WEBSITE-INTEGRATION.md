...
Price guarantee: this backend does not schedule a price increase; the Stripe price stays fixed. The founding cohort defaults to 50 distinct paid or reserved accounts. Paid accounts retain their cohort place after tenant deletion; maintenance releases abandoned unpaid reservations. Configure tax and cancellation copy consistently with the account portal before launch.
